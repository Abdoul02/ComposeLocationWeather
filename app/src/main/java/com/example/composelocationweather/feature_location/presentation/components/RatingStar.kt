...
fun RatingStar(
    ...
    val image = ImageBitmap.imageResource(id = R.drawable.rating_star_30)
    val imageFull = ImageBitmap.imageResource(id = R.drawable.rating_star_full_30)
